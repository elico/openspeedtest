...
(function(bb) {
    ...
    r.prototype.Graph = function(a, c) {
        function f(p, z) {
            ...
            e.polygon = document.createElementNS("http://www.w3.org/2000/svg", "polygon");
    ...
    var ib = function() {
        ...
        function e() {
            ...
            var l = setInterval(function() {
                ...
                "SendR" === n && (d.showStatus("All done"), h = document.createElement("div"), h.innerHTML = '',
                    u = h.querySelector("a"), d.oDoLiveSpeed.el.textContent = Oa, A = document.getElementById("oDoLiveSpeed"), u.innerHTML = A.innerHTML, A.innerHTML = h.innerHTML, location.hostname != L.toLowerCase() + Y ? (U = "https://" + L.toLowerCase() + Y + "/results/show.php?&d=" + N.toFixed(3) + "&u=" + Q.toFixed(3) + "&p=" + wa + "&j=" + xa + "&dd=" + (aa / 1048576).toFixed(3) + "&ud=" + (ba / 1048576).toFixed(3) + "&ua=" + Pa, U = encodeURI(U), h = document.getElementById("resultsData"), h.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", U), h.setAttribute("target",
                        "_blank"), saveData && qa(5)) : qa(3), n = "busy", clearInterval(l))
            }, 100)
        }
